/**
 * Template HTML pour bon de commande PVC COULISSANT WISIO
    ...
    <div class="menuiserie-bloc">
      ...
      <div class="section">
        ...
        <div class="field-row">
          ...
          <span class="value">${data.typeCoulissant || 'Coulissant 2 vtx'}</span>
        </div>
        <div class="field-row">
          <span>Sens: ${checkbox(data.sensOuverture === 'Primaire à Gauche')} Gauche ${checkbox(data.sensOuverture === 'Primaire à droite')} Droite</span>
        </div>
      </div>
      ...
      <div class="section">
        ...
        <div class="field-row">
          ...
          <span>${checkbox(String(data.modeleDormant || "").includes('BC518T'))} BC518T Réno</span>
          <span>${checkbox(String(data.modeleDormant || "").includes('BC540'))} BC540 Neuf</span>
          <span>${checkbox(String(data.modeleDormant || "").includes('BC515'))} BC515 Iso</span>
        </div>
      ...
      <div class="section">
        <h3>POIGNÉES</h3>
        <div class="field-row">
          <span>${checkbox(data.typePoignee === 'Sécustik')} Sécustik</span>
          <span>${checkbox(data.typePoignee === 'Séduction')} Séduction</span>
          <span>${checkbox(data.typePoignee === 'Solène cuvette')} Solène cuvette</span>
        </div>
        <div class="field-row">
          <span class="label">Position:</span>
          <span class="value">${data.positionPoignee || ''}</span>
        </div>
      </div>
...
export function renderBonCommandePvcCoulissant(
