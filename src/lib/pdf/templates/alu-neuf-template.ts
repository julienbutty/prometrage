/**
 * Template HTML pour bon de commande ALU NEUF
 * Version avec VRAIS noms de champs
 */
    ...
    <div class="menuiserie-bloc">
      ...
      <div class="section">
        ...
        <div class="field-row">
          ...
          <span class="value small">${data.intitule || ''}</span>
        </div>
        ${data.rails ? `
        <div class="field-row">
...
export function renderBonCommandeAluNeuf(
