/**
 * Template HTML pour bon de commande PVC NEUF
...
function renderMenuiserieBloc(menuiserie: MenuiserieData, index: number): string {
  ...
  return `
    <div class="menuiserie-bloc">
      ...
      <div class="section">
        <h3>TYPE DE MENUISERIE</h3>
        <div class="field-row">
          <span>${checkbox(data.typeProduit === 'OF')} OF</span>
          <span>${checkbox(data.typeProduit === 'PF')} PF</span>
          <span>${checkbox(data.typeProduit === 'PF serrure')} PF serrure</span>
          <span>${checkbox(data.typeProduit === 'Entrée')} Entrée</span>
        </div>
      </div>
      ...
      <div class="section">
        ...
        <div class="field-row">
          <span>${checkbox(data.repriseDoublage === 'Dt. Monobloc(2)')} Dt. Monobloc</span>
          <span>${checkbox(String(data.repriseDoublage || "").includes('Tapée'))} Tapée rapportée</span>
        </div>
      </div>
      ...
      <div class="section">
        <h3>QUINCAILLERIE</h3>
        <div class="field-group">
          <span class="value small">${data.quincaillerie || ''}</span>
        </div>
      </div>
      ...
      <div class="section">
        ...
        <div class="field-row">
          ...
          <span class="value">${data.hauteurAllege || '__'} mm</span>
          <span class="label">Ht poignée</span>
          <span class="value">${data.hauteurPoignee || '__'} mm</span>
        </div>
      </div>
...
/**
 * Génère le HTML complet du bon de commande PVC NEUF
 */
export function renderBonCommandePvcNeuf(
  ...
  <div class="page">
    ...
    <div class="header">
      ...
      <div class="color-section">
        ...
        <div class="field-row">
          <span>Mode: ${checkbox(firstData.modeColoris === 'Monocolore')} Monocolore ${checkbox(firstData.modeColoris === 'Bicolore')} Bicolore</span>
        </div>
    ...
    <div class="footer">
      ...
      <p><small>Sans précisions de votre part, la fabrication sera conforme au standard du tarif.</small></p>
    </div>
  </div>
</body>
</html>
