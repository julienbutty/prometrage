/**
 * Template HTML pour bon de commande PVC RÉNOVATION
...
/**
 * Génère le HTML complet du bon de commande PVC RÉNOVATION
 */
export function renderBonCommandePvcReno(
