...
| **SWINGLINE**  | Fenêtre/Porte | Gamme PVC avec options avancées |
...
| 4   | PVC      | RENOVATION | FENETRE      | `MENUISERIES_GAMME_PVC_FORM_RENO.md`             | SOFTLINE, SWINGLINE, KIETISLINE |
| 5   | PVC      | NEUF       | FENETRE      | `MENUISERIES_GAMME_PVC_FORM_NEUF.md`             | SOFTLINE, SWINGLINE, KIETISLINE |
| 6   | PVC      | **\***     | COULISSANT   | `MENUISERIES_GAMME_PVC_FORM_COULISSANT_WISIO.md` | WISIO                           |
| 7   | PVC      | **\***     | PORTE_ENTREE | `MENUISERIES_GAMME_PVC_FORM_PE.md`               | SOFTLINE, SWINGLINE, KIETISLINE |
